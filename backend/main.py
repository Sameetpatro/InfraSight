"""
InfraSight API — PixelMapINT obstacle marking (SegFormer semantic → yellow / pink / blue overlay).
...
from ml.integration import init_detector, ml_health, run_detection
